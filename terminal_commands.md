...
sudo reboot
Drink your coffee, and wait until your system becomes up and accessible via ssh or terminal.
Run anydesk --get-status , if its not online then run anydesk --service.
Run anydesk --get-id && echo to get your desk id.
Use your desk id in your Anydesk client, to access the remote system.
